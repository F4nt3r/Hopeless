...
namespace Hopeless
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            pulaEkwipunku = new List<IInventory> { magicorearmor, zorro, claw_of_beliar, crossbow, mercenaryarmor, paladinarmor, heavy_crossbow, ulumulu, sword, gun, durableovercoat, bronzedchestplate, leatherarmor, armour, axe, lightweightarmour, mediumweightarmour, greatsword, glaive, metal_cudge, sharpened_sickle, gilded_mace, scarlet_flail, dagger, spearofdestiny, temeriaarmor, saskiaarmor, hiddenblade, musket, ritual_knife, pieceofeden };


            CommonIventory = new List<IInventory> { new Weapon(sword), new Armor(armour), new Weapon(gun), new Armor(lightweightarmour), new Weapon(ritual_knife), new Armor(mediumweightarmour), new Weapon(axe), new Armor(lightweightarmour) };
            ...
            monsters = new List<Monster> { gaunter, mirage, sleeperGuard, arachas, vampire, wildDog, penitent, tentacles, orkwarrior, leszy, sleeper, gargoyle, boneSoldier, boneArbalest, rattler, creeper, cannon, bigCrab, ghost, giant, ghoul, maggot, webber, webberSpitter, brigandTrainee, brigand, floutist, boneShielder };
            expeditionChoiceUserControl.Monsters = monsters;
            // Inicjalizacja Wypraw
            Expedition expedition1 = new Expedition("Canals_of_Novigrad", "It smells... of corpses in here?", 50, DifficultyType.Easy, new List<Monster> { new Monster(maggot), new Monster(maggot), new Monster(maggot), new Monster(maggot) }, 30, new List<Weapon> { greatsword }, new List<Armor> { mediumweightarmour });
            Expedition expedition2 = new Expedition("Abandoned_Warehouse", "Apparently they used to store Apples here", 50, DifficultyType.Easy, new List<Monster> { new Monster(maggot), new Monster(maggot), new Monster(webber), new Monster(webber) }, 30, new List<Weapon> { greatsword }, new List<Armor> { mediumweightarmour });
            Expedition expedition3 = new Expedition("DeSalle", "Something scary is there, but I don't know what.", 50, DifficultyType.Easy, new List<Monster> { new Monster(maggot), new Monster(maggot), new Monster(maggot), new Monster(floutist) }, 30, new List<Weapon> { greatsword }, new List<Armor> { mediumweightarmour });
            Expedition expedition4 = new Expedition("Forbidden_Forest", "Great Dark Forest, full of spiderwebs", 50, DifficultyType.Easy, new List<Monster> { new Monster(webber), new Monster(webber), new Monster(webberSpitter), new Monster(webberSpitter) }, 30, new List<Weapon> { glaive }, new List<Armor> { });
            Expedition expedition5 = new Expedition("Swamp_Camp", "Illegal swamp herb plantation", 50, DifficultyType.Easy, new List<Monster> { new Monster(brigandTrainee), new Monster(brigandTrainee), new Monster(brigandTrainee), new Monster(brigand) }, 30, new List<Weapon> { dagger }, new List<Armor> { leatherarmor });
            expeditons = new List<Expedition> { expedition1, expedition2, expedition3, expedition4, expedition5 };
            ...
            preparationsUserControl.ReturnButtonClicked += (sender, args) =>
            {
                preparationsUserControl.Visible = false;
                menuUserControl.Visible = true;
            };
