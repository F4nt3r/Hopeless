    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            menuUserControl.NewGameButtonClicked += (sender, args) =>
            {
                ...
                Expedition expedition5 = new Expedition("Swamp Camp", "Illegal swamp herb plantation", 50, DifficultyType.Easy, new List<Monster> { new Monster(brigandTrainee), new Monster(brigandTrainee), new Monster(brigandTrainee), new Monster(brigand) }, 30, new List<Weapon> { dagger }, new List<Armor> { leatherarmor });
